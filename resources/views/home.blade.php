                    ...
                    <div class="p-4 flex-1 flex flex-col">
                        ...
                        <div class="flex gap-2">
                            @if($product->hasVariants())
                                <!-- For products with variants, clicking buttons prevents card navigation -->
                            ...
                            @else
                                <!-- For products without variants, direct actions -->
    ...
    function handleWishlistClick(e) {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Show success toast
                showToast('{{ __("messages.added_to_wishlist") }}', 'success');
            }
        })
        .catch(error => {
